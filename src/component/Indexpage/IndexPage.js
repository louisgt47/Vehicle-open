...
class App extends React.Component {
    componentDidMount=()=>{
        $('.title1').mouseenter(
            function(){
                ...
                $( '.title1 .titletopleft,.title1 .titleenglish,.title1 .titletext').css('color','#fff');
        ...
        $('.title1').mouseleave(
            function(){
                ...
                $( '.title1 .titletopleft,.title1 .titleenglish,.title1 .titletext').css('color','#2d2d2d');
        ...
        $('.title2').mouseenter(
            function(){
                ...
                $( '.title2 .titletopleft,.title2 .titleenglish,.title2 .titletext').css('color','#fff');
        ...
        $('.title2').mouseleave(
            function(){
                ...
                $( '.title2 .titletopleft,.title2 .titleenglish,.title2 .titletext').css('color','#2d2d2d');
        ...
        $('.title3').mouseenter(
            function(){
                ...
                $( '.title3 .titletopleft,.title3 .titleenglish,.title3 .titletext').css('color','#fff');
        ...
        $('.title3').mouseleave(
            function(){
                ...
                $( '.title3 .titletopleft,.title3 .titleenglish,.title3 .titletext').css('color','#2d2d2d');
        ...
        $('.title4').mouseenter(
            function(){
                ...
                $( '.title4 .titletopleft,.title4 .titleenglish,.title4 .titletext').css('color','#fff');
        ...
        $('.title4').mouseleave(
            function(){
                ...
                $( '.title4 .titletopleft,.title4 .titleenglish,.title4 .titletext').css('color','#2d2d2d');
        ...
        $('.title5').mouseenter(
            function(){
                ...
                $( '.title5 .titletopleft,.title5 .titleenglish,.title5 .titletext').css('color','#fff');
        ...
        $('.title5').mouseleave(
            function(){
                ...
                $( '.title5 .titletopleft,.title5 .titleenglish,.title5 .titletext').css('color','#2d2d2d');
        ...
        $('.title6').mouseenter(
            function(){
                ...
                $( '.title6 .titletopleft,.title6 .titleenglish,.title6 .titletext').css('color','#fff');
        ...
        $('.title6').mouseleave(
            function(){
                ...
                $( '.title6 .titletopleft,.title6 .titleenglish,.title6 .titletext').css('color','#2d2d2d');
        ...
        $('.title7').mouseenter(
            function(){
                ...
                $( '.title7 .titletopleft,.title7 .titleenglish,.title7 .titletext').css('color','#fff');
        ...
        $('.title7').mouseleave(
            function(){
                ...
                $( '.title7 .titletopleft,.title7 .titleenglish,.title7 .titletext').css('color','#2d2d2d');
        ...
        for(i=0;i<7;i++)
        {
            $('.titletopleft').eq(i).css({"animation": `animatetitleleft ${4.2+i*0.2}s`  })
            $()
    ...
    var i=0,
        ...
        function rand() {
        var text = "";
        var possible = "abcdefghijklmnopqrstiuvwxyz~&|^ç@][{}ù*µ¤$£€°)(+-/<>²`éè1234567890";
  ...
  render() {
    return (
        ...
        <div class="hover2">
          <div class='hover2box'>
          <img src={require('./images/1.jpg')} alt="" width='100%' class='hover2img'/>
            </div>
        </div>
        <div class="hover3">
          <div class='hover3box'>
          <img src={require('./images/3.jpg')} alt="" width='100%' class='hover3img'/>
            </div>
        </div>
        <div class="hover4">
          <div class='hover4box'>
