...
CheckAccount=(e) => {
  ...
  var data = {"account":e.target.value}
      fetch("http://localhost:4000/registereduseraccountcheck",{
      credentials: 'include',
      method: 'POST',
...
CheckPhone=(e) => {
  if(e.target.value==="")
  {
            document.querySelector('#RegisteredPageInputPhoneHelp').innerHTML='請輸入手機號碼!!!';
  ...
  var data = {"phone":e.target.value}
      fetch("http://localhost:4000/registereduserphonecheck",{
      credentials: 'include',
      method: 'POST',
      body: JSON.stringify(data),
      headers: new Headers({
      ...
      .then(obj => {
        if(obj.data.find)
        {
          ...
          document.querySelector('#RegisteredPageInputPhoneHelp').innerHTML='手機號碼重複!!!';
          document.querySelector('#RegisteredPageInputPhone').style.borderBottomColor='red';
          document.querySelector('#RegisteredPageInputPhoneHelp').style.color='red';
          document.querySelector('#RegisteredPageInputPhoneHelp').style.opacity=1;
          document.querySelector('#RegisteredPageInputButton').style.pointerEvents='none';
          ...
          document.querySelector('#RegisteredPageInputPhoneHelp').style.color='#aaa';
          document.querySelector('#RegisteredPageInputPhoneHelp').innerHTML='手機號碼無人使用';
          document.querySelector('#RegisteredPageInputPhone').style.borderBottomColor='#6EB7B0';
          document.querySelector('#RegisteredPageInputPhoneHelp').style.opacity=1;
          document.querySelector('#RegisteredPageInputButton').style.pointerEvents='auto';
          document.querySelector('#RegisteredPageInputButton').style.opacity=1;
...
CheckEmail=(e) => {
  ...
  var data = {"email":e.target.value}
      fetch("http://localhost:4000/registereduseremailcheck",{
      credentials: 'include',
      method: 'POST',
      body: JSON.stringify(data),
      headers: new Headers({
...
CheckID=(e) => {
  ...
  var data = {"ID":e.target.value}
      fetch("http://localhost:4000/registereduseridcheck",{
      credentials: 'include',
      method: 'POST',
      body: JSON.stringify(data),
      headers: new Headers({
  ...
  if(document.querySelector('#RegisteredPageInputAccountHelp').style.color==='red'){
    alert('帳號錯誤')
        ...
        if(isPassed){
              ...
              fetch("http://localhost:4000/userregistered",{
              method: 'POST',
              body:formData,
            })
              .then(res=>res.json())
            ...
            <div class="RegisteredPage">
              ...
              <div class="RegisteredPageRight">
                  <div class="RegisteredPageInputTextbox">
                      ...
                      <input class="RegisteredPageInput"  id="RegisteredPageInputPhone" name="Phone" placeholder="請輸入連絡電話" onChange={this.CheckPhone} onBlur={this.SetState} />
